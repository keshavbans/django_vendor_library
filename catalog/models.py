...
class Receipt(models.Model):
    ...
    receipt_image = models.ImageField(upload_to='uploads/', blank= False, null= False)
    uuid = models.UUIDField(default=uuid.uuid4, editable=False, verbose_name='Unique ID')
    owner = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='own_boxes', verbose_name='Owner', null=True)
